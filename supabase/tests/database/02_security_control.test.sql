...
select results_eq(
  ...
  $$values
    ...
    ('private.begin_temporary_password_reset(uuid,uuid,uuid,text,uuid)'),
    ...
    ('private.internal_platform_update_company_admin(uuid,uuid,uuid,text,membership_status,module_key[],text,bigint,uuid)'),
